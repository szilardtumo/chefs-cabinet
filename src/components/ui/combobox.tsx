...
const Combobox = (({ className, ...props }: React.ComponentProps<typeof ComboboxPrimitive.Root>) => {
...
function ComboboxLabel({ className, ...props }: React.ComponentProps<typeof ComboboxPrimitive.Label>) {
  return (
...
function ComboboxAnchor({ className, ...props }: React.ComponentProps<typeof ComboboxPrimitive.Anchor>) {
  return (
...
function ComboboxTrigger({ className, children, ...props }: React.ComponentProps<typeof ComboboxPrimitive.Trigger>) {
  return (
...
function ComboboxCancel({ className, ...props }: React.ComponentProps<typeof ComboboxPrimitive.Cancel>) {
  return (
...
function ComboboxBadgeList({ className, ...props }: React.ComponentProps<typeof ComboboxPrimitive.BadgeList>) {
  return (
...
function ComboboxLoading({ className, ...props }: React.ComponentProps<typeof ComboboxPrimitive.Loading>) {
  return (
...
function ComboboxGroup({ className, ...props }: React.ComponentProps<typeof ComboboxPrimitive.Group>) {
  return <ComboboxPrimitive.Group data-slot="combobox-group" className={cn('overflow-hidden', className)} {...props} />;
}
...
function ComboboxItemIndicator({ ...props }: React.ComponentProps<typeof ComboboxPrimitive.ItemIndicator>) {
...
function ComboboxItemText({ ...props }: React.ComponentProps<typeof ComboboxPrimitive.ItemText>) {
  return <ComboboxPrimitive.ItemText {...props} />;
}
